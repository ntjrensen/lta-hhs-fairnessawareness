...
We maken een summary en tonen de samenvattende tabel.
...
tblOpleiding_inschrijvingen <- dfOpleiding_inschrijvingen_srvy |>
  tbl_summary(
    by = Retentie,
    statistic = list(
    ...
    missing = "no",
    percent = "row",
    include = c(-ID, -Collegejaar) ## Sluit ID en Collegejaar uit van de samenvatting
  ) |>
...
gt_tbl <- as_gt(tblOpleiding_inschrijvingen) 
gt_tbl |> 
  gtsave("10. Output/gs/tblOpleiding_inschrijvingen.png", expand = 10)
