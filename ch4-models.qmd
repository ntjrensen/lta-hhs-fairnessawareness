...
dfOpleiding_inschrijvingen_base <- dfOpleiding_inschrijvingen_base |>  
  ...
  c(
    ...
    list(lLevels[["Studiekeuzeprofiel"]], lLevels[["Aansluiting"]], lLevels[["Vooropleiding"]])
  )
...
We evalueren het finale model op basis van 4 metrieken: 1) accuraatheid, 2) ROC/AUC en 3) de [Brier score](https://en.wikipedia.org/wiki/Brier_score) (de Mean Squared Error).
