...
-   The **YAML header** with:
    ...
    -   `params` with options for the study programme and report:
        ...
        -   `propedeusediploma`: whether to take a propedeutic degree
        ...
        -   `opleidingsvorm_afkorting`: the type of education
...
-   This file is executed only once per session; if there is a new
    ...
    for a new session or adjust the `bReset_Setup` variable at the top
    of the page from `bReset_Setup <- F` once to `T`.
...
-   In `_Setup_config.R`: modify the metadata to determine the source
    ...
    -   `lResearch_settings[[“sResearch_path”]]`: the name of this
        project to be used in filepaths
    -   `lResearch_settings[[“sSucces_label”]]`: the name of measure for
        success
    -   `lResearch_settings[[“sInstelling”]]`: the name of your
        institution
    -   `lResearch_settings[[“sBron”]]`: who provided the dataset you
        are using
