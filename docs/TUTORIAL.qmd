...
build your first report if you have not done so yet. Otherwise, try to run a single page following the instructions below or continue to the next step: Changing a study programme. 

Since the template has several dependencies,
you must render the pages using the terminal. Do *not* render
