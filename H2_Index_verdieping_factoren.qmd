...
# Format and output
output-file: "lta-hhs-tidymodels-h2-verdieping-factoren.html"
...
# Adjust the Retentie variable to numeric (0/1), 
# so it can be turned into an explainer
...
#| fig-cap: "Opbouw van de kans op retentie"
#| echo: false
#| results: asis
...
# Create variables splits for each continuous
...
{{< include R/qmd/justification.qmd >}}
:::
