...
params:
  ...
  # ## TIS:W DU
  # faculteit: "TIS"
  # opleidingsnaam: "B Werktuigbouwkunde"
  # opleiding: "W"
  # opleidingsvorm: "duaal"
  # opleidingsvorm_afkorting: "DU"
  # selectie: false
...
*Ter illustratie* Stel dat we een onderscheid maken tussen mbo en havo studenten, dan bepalen we de mediaan van numerieke variabelen en de frequentste waarde van categorische variabelen. Van de leeftijd kan misschien 20 het vaakst voorkomen, etc.
