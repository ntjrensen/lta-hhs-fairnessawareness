...
`r kableExtra::text_spec("**1. Accuracy Equality Ratio**", color = lColors[["institution"]][["institution-color-two"]])`
...
`r kableExtra::text_spec("**2. Equal Opportunity Ratio**", color = lColors[["institution"]][["institution-color-two"]])`
...
`r kableExtra::text_spec("**3. Predictive Equality Ratio**", color = lColors[["institution"]][["institution-color-two"]])`
...
`r kableExtra::text_spec("**4. Predictive Parity Ratio**", color = lColors[["institution"]][["institution-color-two"]])`
...
`r kableExtra::text_spec("**5. Statistical Parity Ratio**", color = lColors[["institution"]][["institution-color-two"]])`
