...
lang: nl
language: 
  other-links-title: "Meer informatie"
...
format:
  html:
    ...
    theme: 
    - lumen
    - "01. Includes/scss/lta.scss"
    self-contained: true
    other-links:
      - text: "Over het lectoraat Learning Technology & Analytics"
        href: https://www.dehaagsehogeschool.nl/onderzoek/lectoraten/learning-technology-analytics
      - text: "Over het onderzoeksprogramma 'No Fairness without Awareness'"
        href: https://www.dehaagsehogeschool.nl/onderzoek/kenniscentra/no-fairness-without-awareness
...
## +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## 0.1 Standaard packages die direct nodig zijn ####
...
## Pas lLevels aan, zodat deze goed gesorteerd worden
lLevels_skp <-
  intersect(
    lLevels_skp,
    unique(
      dfOpleiding_inschrijvingen_base$VOP_Studiekeuzeprofiel_LTA_afkorting
    )
  )
lLevels_aansluiting <-
  intersect(
    lLevels_aansluiting,
    unique(dfOpleiding_inschrijvingen_base$INS_Aansluiting_LTA)
  )
lLevels_vop <-
  intersect(
    lLevels_vop,
    unique(
      dfOpleiding_inschrijvingen_base$VOP_Toelaatgevende_vooropleiding_soort
    )
  )
